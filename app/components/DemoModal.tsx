...
import { X, Mail, Phone, User, Building2, Send, Check, Calendar, Clock } from 'lucide-react';
                ...
                <div className="flex items-start justify-between gap-3 sm:gap-4">
                  ...
                  >
                    ...
                    >
                      Agende sua
                      <br />
                      <span className="text-[var(--accent)] font-normal">Demonstração</span>
                    </h2>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      >
                        ...
                        <div className="relative">
                          <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 sm:w-4 sm:h-4 text-[var(--foreground-secondary)]/40 group-focus-within:text-[var(--accent)] transition-colors duration-300" />
                          <input
                            type="date"
                            name="date"
                            value={formData.date}
                      ...
                      >
                        ...
                        <div className="relative">
                          <Clock className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 sm:w-4 sm:h-4 text-[var(--foreground-secondary)]/40 group-focus-within:text-[var(--accent)] transition-colors duration-300" />
                          <input
                            type="time"
                            name="time"
                            value={formData.time}
