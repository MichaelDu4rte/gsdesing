              ...
              >
                {service.isModal ? (
                  <div 
                    ...
                    className="relative h-full p-6 sm:p-8 md:p-10 bg-gradient-to-br from-[var(--bege-quente)]/30 to-[var(--off-white)]/50 border border-[var(--bege-quente)]/40 hover:border-[var(--dourado-fosco)]/50 backdrop-blur-sm transition-all duration-500 overflow-hidden cursor-pointer"
                    style={{
